        ...
        public OperateWindow(final Context context) {
            ...
            contentView.findViewById(R.id.tv_copy).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String str = mSelectionInfo.mSelectionContent;
                    ...
                    //LogUtils.e("=============>>"+ new SpannableString( Html.fromHtml(mSelectionInfo.mSelectionContent)).toString().replace("  ","").replace("   ","") );
                    clip.setPrimaryClip(
                        ClipData.newPlainText(mSelectionInfo.mSelectionContent,new SpannableString( Html.fromHtml(mSelectionInfo.mSelectionContent)).toString().replace(indentSpaces,"\n").replace("*","")));
                    if (mSelectListener != null) {
                        //LogUtils.e("=============>>"+mSelectionInfo.mSelectionContent);
                        mSelectListener.onTextSelected(new SpannableString( Html.fromHtml(mSelectionInfo.mSelectionContent)).toString().replace(indentSpaces,"\n").replace("*",""));
                    }
